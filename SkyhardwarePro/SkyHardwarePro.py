...
def dados_usuario():
    ...
    print("==")
    print("==")
    print("== This software was made by the Skyrats hardware team \n== at the Polytechnic School of the University of São Paulo - Brasil.")
    print("==")
    ...
    Tep = Tep()
    return Pframe,prop_diam_max,Tep
...
def Tempo_de_voo():
    ...
    #Dados do Usuário
    Pframe,prop_diam_max,Tep = dados_usuario()
    ...
    if len(list_bat_mot_prop) != 0:
        ...
        with pd.option_context('display.max_rows', None, 'display.max_columns', None): 
            ...
            #print(page)
            url = 'file:///home/zolubas/Desktop/SkyhardwarePro/SkyHardwarePro_results.html'
        ...
        #page =  urllib.urlopen('SkyHardwarePro_results.html').read()
        #print(page)
        urlERROR = 'file:///home/zolubas/Desktop/SkyhardwarePro/ErrorMsg.html'
